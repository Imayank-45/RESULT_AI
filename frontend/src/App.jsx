      ...
      <div className="dashboard-grid">
        ...
        >
          ...
          {isRunning && (
            ...
            >
              <p style={{ color: 'var(--warning)', fontWeight: '800', marginBottom: '6px', display: 'flex', alignItems: 'center', gap: '6px' }}>
              ...
              <p style={{ color: 'var(--text-main)', opacity: 0.85 }}>
                A local Playwright Chromium window has popped up. Please complete the CAPTCHA inside that browser window for 
                each student to resume processing automatically.
              </p>
            </motion.div>
          )}
        </motion.aside>
                        ...
                        <td>
                          {!rec.not_found && (
                            <button 
                              ...
                              style={{ padding: '4px 10px', fontSize: '11px', width: 'auto', borderRadius: '6px' }}
                            >
                              View Grades
                            </button>
                          )}
        ...
        {selectedRecord && (
          ...
          >
            ...
            >
              ...
              <div style={{ marginBottom: '18px', borderBottom: '1px solid var(--card-border)', paddingBottom: '10px' }}>
